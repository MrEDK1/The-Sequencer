        ...
        function(object) {
            ...
            */
            ...
            /*
                ...
                Om Händelsen är markerad just nu
                håller användaren fortfarande på
                att arbeta med den.

                Då ska vi INTE varna ännu.
            */
...
function recheckWarnings() {
    ...
    /*
        ...
        diagrammets nuvarande tillstånd.
    */
...
newWarnings.push(
    ...
    /*
        ...
        Då glömmer vi att den var ignorerad,
        så att den kan dyka upp igen om samma
...
function addIOFromQuickFields() {
    ...
    */
    ...
    /*
        Ladder ska kunna uppdateras direkt
        senare när beskrivningar visas där.
    */
            ...
            */
            ...
            addressInput.addEventListener(
                ...
                function() {
                    ...
                    /*
                        Om den nya adressen redan
                        finns använder vi den posten
                        i stället för att skapa
                        en dubblett.
                    */
...
function setIOEntry(
    ...
    /*
        ...
        Uppdatera samma post i stället
...
function isObjectMultiSelected(
    id
) {
...
/* =====================================================
   GÖR PLATS FÖR EN NY GRENKOLUMN

   Alla grenar som ligger på den önskade
   platsen eller längre åt höger skjuts
   ett helt kolumnsteg åt höger.
===================================================== */

function makeRoomForBranchColumn(
    wantedX,
    columnWidth
) {

    /*
        Hämta alla grenar som ligger i eller
        till höger om den nya kolumnen.

        Vi börjar med den längst till höger,
        så att inget trycks ovanpå något annat.
    */
    ...
    branchesToMove.forEach(
        function(branch) {
            ...
            /*
                reflowBranch använder branch.x
                för att placera både händelser
                och övergångar på rätt X-position.
            */
    ...
    /*
        Rita om allt eftersom grenarnas
        start- och återkopplingslinjer också
        måste följa med.
    */
...
function calculateBranchX(
    ...
    /* =================================================
       ...
       Den nya grenen ska hamna direkt
       till höger om modergrenen.

       Om platsen redan används skjuts
       grenarna därifrån åt höger.
    ================================================= */
    ...
    /* =================================================
       ...
       En ny gren från huvudlinjen ska alltid
       försöka använda första grenkolumnen.

       Om en eller flera grenar redan ligger där
       skjuts de åt höger så den nya grenen
       får plats närmast huvudlinjen.
    ================================================= */
    ...
    /* =================================================
       GÖR PLATS FÖR DEN NYA GRENEN

       Alla befintliga grenar som ligger
       på den önskade kolumnen eller längre
       åt höger flyttas ett steg åt höger.
    ================================================= */

    makeRoomForBranchColumn(
        wantedX,
        columnWidth
    );
...
function createBranch(type) {
    ...
    /*
        Grenar ska fortfarande startas
        från huvudlinjen.
    */
...
/* =====================================================
   INFOGA OBJEKT MELLAN TVÅ BEFINTLIGA OBJEKT
===================================================== */

function insertObjectBetween(
    previous,
    next,
    newObject
) {
    ...
    /*
        Hitta den befintliga direkta
        kopplingen:

            previous → next

        Vi ändrar bara vanliga vertikala
        connections här.

        Gren-start och reconnect hanteras
        separat.
    */

    const oldConnectionIndex =
    ...
    */
    ...
    /*
        Om vi arbetar inne på en gren
        ska det nya objektet tillhöra
        samma gren.
    */
    ...
    /*
        ...
        På huvudlinjen börjar vi från
        previous.

        På en gren packar vi om
        hela den berörda grenen.
    */
...
const description =
    (
        /^X\d+$/.test(normalizedAddress) ||
        /^Y\d+$/.test(normalizedAddress) ||
        /^T\d+$/.test(normalizedAddress) ||
        /^C\d+$/.test(normalizedAddress)
    )
        ? getIODescription(
            normalizedAddress
        )
...
function createLadderCoil(
    ...
    /*
        I/O-beskrivning används just nu
        för Y-utgångar.

        SET/RST av M-minnen påverkas inte.
    */
...
function saveAsImage() {
    ...
    /*
        I/O-listan ska alltid använda
        samma sortering som I/O-fönstret.
    */
    ...
    */
    ...
    /*
        Bilden måste vara minst tillräckligt
        bred för I/O-tabellen.
    */
    ...
    /*
        Diagrammets gamla höjd plus
        eventuell I/O-tabell.
    */
    ...
    /*
        2x upplösning för skarpare PNG.
    */
